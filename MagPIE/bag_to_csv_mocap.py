...
class ROSNode:
    def __init__(self):
        ...
        self.csv_file_path = 'dataset/Ground_Truth_Evaluation/magpie2Dataset_loc003_mocap.csv'
        file_exists = os.path.isfile(self.csv_file_path)
        self.csv_file = open(self.csv_file_path, mode='a')
        self.csv_writer = csv.writer(self.csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        # rospy.Subscriber('/tf', TFMessage, self.tf_callback)
        # rospy.Subscriber('/imu_chatter_B1', Imu, self.imu_callback)
        ...
        rospy.Subscriber('/mocap/posestamped', PoseStamped, self.mocap_callback)
    ...
    def mocap_callback(self, data):
        self.csv_writer.writerow([data.header.stamp, data.pose.position.x, 
